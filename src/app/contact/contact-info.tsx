...
const contactMethods = [
  ...
  },
  {
    ...
    label: "WhatsApp",
    value: "Chat with us",
    href: "https://wa.me/message/media4u",
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const socialLinks = [
  {
    name: "Instagram",
    href: "https://www.instagram.com/media4uvr/",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "YouTube",
    href: "https://www.youtube.com/channel/UCg-C-WFQDr0OdGVI8YX4V5w",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "Facebook",
    href: "https://www.facebook.com/profile.php?id=61579292186792",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "TikTok",
    href: "https://www.tiktok.com/@media4uvr",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
