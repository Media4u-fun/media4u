    ...
    <div className="space-y-6">
      ...
      <div className="glass-elevated rounded-2xl p-6">
        ...
        <p className="text-sm text-gray-400 mb-5">
          Connect your Media4U Google Calendar so events created via Quick Add automatically appear there.
        </p>
        {googleConnected ? (
          <div className="flex items-center justify-between p-4 rounded-xl bg-green-500/10 border border-green-500/30">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400">Events will sync to your Media4U calendar</p>
              </div>
            </div>
            <button
              onClick={async () => {
              ...
              className="px-4 py-2 rounded-lg bg-red-500/10 border border-red-500/30 text-red-400 hover:bg-red-500/20 transition-all text-sm disabled:opacity-50"
            >
          ...
          <a
            ...
            rel="noreferrer"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white text-gray-800 font-medium hover:bg-gray-100 transition-all"
          >
